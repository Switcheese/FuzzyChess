...
namespace FuzzyLogic
{
    ...
    public class FuzzyRuleEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("규칙퍼지를 지정해주세요.", style);
            EditorGUILayout.Space(); EditorGUILayout.Space();
            EditorGUILayout.PropertyField(serializedObject.FindProperty("df_FuzzyRule"), new GUIContent("Fuzzy"));
