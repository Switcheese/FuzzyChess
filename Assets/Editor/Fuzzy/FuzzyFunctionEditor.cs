...
{
    [CustomPropertyDrawer(typeof(FuzzyFunction))]
    public class FuzzyFunctionEditor : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
        {
            ...
            SerializedProperty fuzzyRule = prop.FindPropertyRelative("fuzzySet");
